...
3. Create a directory of `images` at the project's root and copy these [images]([https://sdkman.io/](https://github.com/k8s-spring-ai-workshop/talent-arena/tree/exercise4-image-recognition/images) there.
